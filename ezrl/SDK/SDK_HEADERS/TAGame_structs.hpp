...
// ScriptStruct TAGame.MenuTreeNode_TA.MenuTreeNodeData
// 0x0028
struct FMenuTreeNodeData
{
	struct FName                                       NodeID;                                        // 0x0000 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
...
struct FEngagementEventData
{
	...
	class FString                                      UTCStartTime;                                  // 0x0020 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      UTCEndTime;                                    // 0x0030 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint32_t                                           bEndingSoon : 1;                               // 0x0040 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
	uint32_t                                           bLiveNow : 1;                                  // 0x0040 (0x0004) [0x0000000000002000] [0x00000002] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                               		// 0x0044 (0x0004) MISSED OFFSET
	uint64_t                                           EpochSoonEndTime;                              // 0x0048 (0x0008) [0x0000000000002000] (CPF_Transient)
	uint64_t                                           EpochStartTime;                                // 0x0050 (0x0008) [0x0000000000002000] (CPF_Transient)
	uint64_t                                           EpochEndTime;                                  // 0x0058 (0x0008) [0x0000000000002000] (CPF_Transient)
};
