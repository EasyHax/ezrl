...
// 0x002C (0x0280 - 0x02AC)
class AInternetLink : public AInfo
{
public:
	ELinkMode                                          LinkMode;                                      // 0x0280 (0x0001) [0x0000000000000000]               
	ELineMode                                          InLineMode;                                    // 0x0281 (0x0001) [0x0000000000000000]               
	ELineMode                                          OutLineMode;                                   // 0x0282 (0x0001) [0x0000000000000000]               
	EReceiveMode                                       ReceiveMode;                                   // 0x0283 (0x0001) [0x0000000000000000]               
	uint8_t                                           UnknownData00[0x4];                            // 0x0284 (0x0004) MISSED OFFSET
	struct FPointer                                    Socket;                                        // 0x0288 (0x0008) [0x0000000000000002] (CPF_Const)   
	int32_t                                            Port;                                          // 0x0290 (0x0004) [0x0000000000000002] (CPF_Const)   
	uint8_t                                           UnknownData01[0x4];                            // 0x0294 (0x0004) MISSED OFFSET
	struct FPointer                                    RemoteSocket;                                  // 0x0298 (0x0008) [0x0000000000000002] (CPF_Const)   
	struct FPointer                                    PrivateResolveInfo;                            // 0x02A0 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            DataPending;                                   // 0x02A8 (0x0004) [0x0000000000000002] (CPF_Const)   
...
public:
	...
	ELinkState                                         LinkState;                                     // 0x02B0 (0x0001) [0x0000000000000000]               
	uint8_t                                           UnknownData01[0x3];                            // 0x02B1 (0x0003) MISSED OFFSET
	struct FIpAddr                                     RemoteAddr;                                    // 0x02B4 (0x0014) [0x0000000000000000]               
	class UClass*                                      AcceptClass;                                   // 0x02C8 (0x0008) [0x0000000000000000]               
	TArray<uint8_t>                                    SendFIFO;                                      // 0x02D0 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
	class FString                                      RecvBuf;                                       // 0x02E0 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
...
// 0x01D0 (0x02F0 - 0x04C0)
class AWebServer : public ATcpLink
{
public:
	class FString                                      ServerName;                                    // 0x02F0 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class FString                                      Applications[0xA];                             // 0x0300 (0x00A0) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	class FString                                      ApplicationPaths[0xA];                         // 0x03A0 (0x00A0) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	uint32_t                                           bEnabled : 1;                                  // 0x0440 (0x0004) [0x0000000000004000] [0x00000001] (CPF_Config)
	int32_t                                            ListenPort;                                    // 0x0444 (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            MaxConnections;                                // 0x0448 (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            DefaultApplication;                            // 0x044C (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            ExpirationSeconds;                             // 0x0450 (0x0004) [0x0000000000004000] (CPF_Config)  
	uint8_t                                           UnknownData00[0x4];                            // 0x0454 (0x0004) MISSED OFFSET
	class FString                                      ServerURL;                                     // 0x0458 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class UWebApplication*                             ApplicationObjects[0xA];                       // 0x0468 (0x0050) [0x0000000000000000]               
	int32_t                                            ConnectionCount;                               // 0x04B8 (0x0004) [0x0000000000000000]               
	int32_t                                            ConnID;                                        // 0x04BC (0x0004) [0x0000000000000000]               
...
// 0x0044 (0x02F0 - 0x0334)
class AWebConnection : public ATcpLink
{
public:
	class AWebServer*                                  WebServer;                                     // 0x02F0 (0x0008) [0x0000000000000000]               
	class FString                                      ReceivedData;                                  // 0x02F8 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	uint32_t                                           bDelayCleanup : 1;                             // 0x0320 (0x0004) [0x0000000000000000] [0x00000001] 
	int32_t                                            RawBytesExpecting;                             // 0x0324 (0x0004) [0x0000000000000000]               
	int32_t                                            MaxValueLength;                                // 0x0328 (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            MaxLineLength;                                 // 0x032C (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            ConnID;                                        // 0x0330 (0x0004) [0x0000000000000000]               
