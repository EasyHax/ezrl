...
// 0x00C0 (0x0280 - 0x0340)
class AFXActor_X : public AActor
{
public:
	class UFXActorEvent_X*                             SpawnState;                                    // 0x0280 (0x0008) [0x0000000000000000]               
	class UFXActorEvent_X*                             ActivationState;                               // 0x0288 (0x0008) [0x0000000000000000]               
	TArray<struct FFXAttachment>                       Attachments;                                   // 0x0290 (0x0010) [0x0002000000480001] (CPF_Edit | CPF_Component | CPF_NeedCtorLink)
	EFXLocality                                        Locality;                                      // 0x02A0 (0x0001) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                           UnknownData00[0x3];                            // 0x02A1 (0x0003) MISSED OFFSET
	struct FName                                       SocketOrBoneName;                              // 0x02A4 (0x0008) [0x0000000000000001] (CPF_Edit)    
	uint32_t                                           bDeactivateWhenOwnerDestroyed : 1;             // 0x02AC (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bAllowShadowCasting : 1;                       // 0x02AC (0x0004) [0x0000000000000001] [0x00000002] (CPF_Edit)
	uint32_t                                           bAutoActivate : 1;                             // 0x02AC (0x0004) [0x0000000000000001] [0x00000004] (CPF_Edit)
	uint32_t                                           bRenderInactive : 1;                           // 0x02AC (0x0004) [0x0000000000000001] [0x00000008] (CPF_Edit)
	uint32_t                                           bActive : 1;                                   // 0x02AC (0x0004) [0x0000004000002000] [0x00000010] (CPF_Transient)
	uint32_t                                           bHadOwner : 1;                                 // 0x02AC (0x0004) [0x0000004000002002] [0x00000020] (CPF_Const | CPF_Transient)
	class AFXActor_X*                                  Parent;                                        // 0x02B0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class AActor*                                      AttachmentActor;                               // 0x02B8 (0x0008) [0x0000004000002000] (CPF_Transient)
	TArray<class UFXActorEvent_X*>                     FXStates;                                      // 0x02C0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	TArray<struct FFXActorEventCheck>                  FXEvents;                                      // 0x02D0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	float                                              DestroyWaitTime;                               // 0x02E0 (0x0004) [0x0000000000000001] (CPF_Edit)    
	float                                              DestroyTime;                                   // 0x02E4 (0x0004) [0x0000004000000000]               
	class UParameterDispenser_X*                       Parameters;                                    // 0x02E8 (0x0008) [0x0000000004080009] (CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline)
	int32_t                                            EditID;                                        // 0x02F0 (0x0004) [0x0000000800020003] (CPF_Edit | CPF_Const | CPF_EditConst)
	uint8_t                                           UnknownData01[0x4];                            // 0x02F4 (0x0004) MISSED OFFSET
	TArray<struct FFXEventSubscription>                EventSubscriptions;                            // 0x02F8 (0x0010) [0x0000004000402002] (CPF_Const | CPF_Transient | CPF_NeedCtorLink)
	class UFXActorEvent_X*                             AnimationEndState;                             // 0x0308 (0x0008) [0x0000000000000000]               
	struct FScriptDelegate                             __EventFXStatePushed__Delegate;                // 0x0310 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventFXStatePopped__Delegate;                // 0x0328 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0020 (0x0280 - 0x02A0)
class AArchetypePrefab_X : public AActor
{
public:
	TArray<class AActor*>                              PrefabArchetypes;                              // 0x0280 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	TArray<class AActor*>                              ArchetypeInstances;                            // 0x0290 (0x0010) [0x0000000000402002] (CPF_Const | CPF_Transient | CPF_NeedCtorLink)
...
// 0x0070 (0x0280 - 0x02F0)
class AArchetypeSpawnPoint_X : public AActor
{
public:
	struct FPointer                                    VfTable_IInterface_NavMeshPathObject;          // 0x0280 (0x0008) [0x0000000000801002] (CPF_Const | CPF_Native | CPF_NoExport)
	class FString                                      ArchetypePath;                                 // 0x0288 (0x0010) [0x0000080000400003] (CPF_Edit | CPF_Const | CPF_NeedCtorLink)
	uint32_t                                           bSeedNavMesh : 1;                              // 0x0298 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bSpawnOnLevelStart : 1;                        // 0x0298 (0x0004) [0x0000000000000001] [0x00000002] (CPF_Edit)
	uint32_t                                           bOnlyAllowOneInstance : 1;                     // 0x0298 (0x0004) [0x0000000000000001] [0x00000004] (CPF_Edit)
	uint8_t                                           UnknownData00[0x4];                            // 0x029C (0x0004) MISSED OFFSET
	class AActor*                                      ActorArchetype;                                // 0x02A0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class USpriteComponent*                            PlacementSprite;                               // 0x02A8 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class USkeletalMeshComponent*                      ArchetypeSkeletalMesh;                         // 0x02B0 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UStaticMeshComponent*                        ArchetypeStaticMesh;                           // 0x02B8 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	TArray<class AActor*>                              SpawnedActors;                                 // 0x02C0 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	class AActor*                                      SpawnedActor;                                  // 0x02D0 (0x0008) [0x0000000000002000] (CPF_Transient)
	struct FScriptDelegate                             __EventSpawned__Delegate;                      // 0x02D8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0110 (0x05D0 - 0x06E0)
class ACamera_X : public ACamera
{
public:
	TArray<class UCameraState_X*>                      States;                                        // 0x05D0 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	struct FRotator                                    PCDeltaRotation;                               // 0x05E0 (0x000C) [0x0000000000002000] (CPF_Transient)
	struct FRotator                                    OldControllerRotation;                         // 0x05EC (0x000C) [0x0000000000002000] (CPF_Transient)
	struct FVector                                     PCDeltaLocation;                               // 0x05F8 (0x000C) [0x0000000000002000] (CPF_Transient)
	struct FVector                                     OldControllerLocation;                         // 0x0604 (0x000C) [0x0000000000002000] (CPF_Transient)
	struct FCameraOrientation                          PreProcessPOV;                                 // 0x0610 (0x002C) [0x0000000000002000] (CPF_Transient)
	struct FCameraOrientation                          PostProcessPOV;                                // 0x063C (0x002C) [0x0000000000002000] (CPF_Transient)
	class UCameraStateBlender_X*                       Blender;                                       // 0x0668 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	struct FVector                                     ShakeLocationOffset;                           // 0x0670 (0x000C) [0x0000000000002002] (CPF_Const | CPF_Transient)
	struct FRotator                                    ShakeRotationOffset;                           // 0x067C (0x000C) [0x0000000000002002] (CPF_Const | CPF_Transient)
	float                                              ShakeFOVOffset;                                // 0x0688 (0x0004) [0x0000000000002002] (CPF_Const | CPF_Transient)
	struct FColor                                      StartFadeColor;                                // 0x068C (0x0004) [0x0000000000002000] (CPF_Transient)
	struct FColor                                      EndFadeColor;                                  // 0x0690 (0x0004) [0x0000000000002000] (CPF_Transient)
	struct FVector                                     ClipOffset;                                    // 0x0694 (0x000C) [0x0000000000002000] (CPF_Transient)
	TArray<struct FLocationCameraKnock>                LocationKnocks;                                // 0x06A0 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	TArray<struct FRotationCameraKnock>                RotationKnocks;                                // 0x06B0 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	uint32_t                                           bDisableCameraShake : 1;                       // 0x06C0 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
	uint32_t                                           bSnapNextTransition : 1;                       // 0x06C0 (0x0004) [0x0000000000002000] [0x00000002] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x06C4 (0x0004) MISSED OFFSET
	struct FScriptDelegate                             __EventCameraStateChanged__Delegate;           // 0x06C8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class FString                                      LoggedInPlayerName;                            // 0x0108 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      PlayerUID;                                     // 0x0118 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      Platform;                                      // 0x0128 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	uint32_t                                           bLoggedIn : 1;                                 // 0x0138 (0x0004) [0x0000004000000000] [0x00000001] 
	uint32_t                                           bPlatformTokenAuthenticationFailed : 1;        // 0x0138 (0x0004) [0x0000004000002000] [0x00000002] (CPF_Transient)
	uint32_t                                           bPlatformAuthTicketFailed_Switch : 1;          // 0x0138 (0x0004) [0x0000004000002000] [0x00000004] (CPF_Transient)
	uint32_t                                           bSkipAuth : 1;                                 // 0x0138 (0x0004) [0x0001004000000000] [0x00000008] 
	uint32_t                                           bLastChanceAuthBan : 1;                        // 0x0138 (0x0004) [0x0000004000002000] [0x00000010] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x013C (0x0004) MISSED OFFSET
	class UError*                                      AuthLoginError;                                // 0x0140 (0x0008) [0x0000004000000000]               
	class UBanMessage_X*                               BanMessage;                                    // 0x0148 (0x0008) [0x0000004000002000] (CPF_Transient)
	class FString                                      EncryptedAuthTicket;                           // 0x0150 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      EpicAuthTicket;                                // 0x0160 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	int32_t                                            AuthRequestFailureMax;                         // 0x0170 (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            AuthRequestRetryTime;                          // 0x0174 (0x0004) [0x0000000000000002] (CPF_Const)   
	int32_t                                            AuthRequestFailureCount;                       // 0x0178 (0x0004) [0x0000000000002000] (CPF_Transient)
	uint8_t                                           UnknownData01[0x4];                            // 0x017C (0x0004) MISSED OFFSET
	class FString                                      AuthenticatedName;                             // 0x0180 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UEpicLogin_X*                                EpicLogin;                                     // 0x0190 (0x0008) [0x0000008000000000]               
	class UError*                                      PrimaryAccountNotSetError;                     // 0x0198 (0x0008) [0x0000000000000000]               
	struct FScriptDelegate                             __EventLoginChanged__Delegate;                 // 0x01A0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventBanned__Delegate;                       // 0x01B8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLoginResult__Delegate;                  // 0x01D0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlatformAuthTicketFailedChanged_Switch__Delegate;// 0x01E8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventConnectionStatusChanged__Delegate;      // 0x0200 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class UErrorType*                                  NotAuthorized;                                 // 0x0268 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameServerPending;                             // 0x0270 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  CacheError;                                    // 0x0278 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  WordFilterEvil;                                // 0x0280 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  WordFilterPlatformError;                       // 0x0288 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  WordFilterPlatformChatError;                   // 0x0290 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidSettings;                               // 0x0298 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  Maintenance;                                   // 0x02A0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlatformAuthError;                             // 0x02A8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MicrotransactionAuthExpired;                   // 0x02B0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  CannotFriendSelf;                              // 0x02B8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  CannotBlockSelf;                               // 0x02C0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidPlayer;                                 // 0x02C8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendRequestNotFound;                         // 0x02D0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendRequestFailed;                           // 0x02D8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AlreadyFriends;                                // 0x02E0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendLimitReached;                            // 0x02E8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  LocalFriendLimitReached;                       // 0x02F0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  RemoteFriendLimitReached;                      // 0x02F8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  LocalHostConnectionError;                      // 0x0300 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  UGCRestricted;                                 // 0x0308 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MicrotransactionServiceMaintenance;            // 0x0310 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GenericStorageOutOfSync;                       // 0x0318 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GenericStorageSync_RequestNotFound;            // 0x0320 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  SignatureMismatch;                             // 0x0328 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  JsonDeserialization;                           // 0x0330 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidPlatform;                               // 0x0338 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidPlatformForCodeRedemption;              // 0x0340 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidParameters;                             // 0x0348 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UPsyNetErrorType_X*                          NotMatchmaking;                                // 0x0350 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AccessDenied;                                  // 0x0358 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UPsyNetErrorType_X*                          PerConDisconnected;                            // 0x0360 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AccountNotFound;                               // 0x0368 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  ServerNotFound;                                // 0x0370 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UPsyNetErrorType_X*                          ExpiredDsConnectToken;                         // 0x0378 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MatchmakingNoInternet;                         // 0x0380 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PartyRankDisparity;                            // 0x0388 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendAddsThrottledGeneric;                    // 0x0390 (0x0008) [0x0000000000000002] (CPF_Const)   
...
// 0x0058 (0x0488 - 0x04E0)
class AGameInfo_X : public AGameInfo
{
public:
	class AGameReplicationInfo*                        GameReplicationInfoArchetype;                  // 0x0488 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class APlayerController*                           PlayerControllerArchetype;                     // 0x0490 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class APawn*                                       PawnArchetype;                                 // 0x0498 (0x0008) [0x0000000000000001] (CPF_Edit)    
	TArray<struct FPauserData>                         PCPausers;                                     // 0x04A0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventSpawned__Delegate;                      // 0x04B0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0058 (0x0280 - 0x02D8)
class AMapFlythroughProfiler_X : public AActor
{
public:
	float                                              Accel;                                         // 0x0280 (0x0004) [0x0000000000000001] (CPF_Edit)    
	float                                              TurnRate;                                      // 0x0284 (0x0004) [0x0000000000000001] (CPF_Edit)    
	float                                              ProfileTime;                                   // 0x0288 (0x0004) [0x0000000000000001] (CPF_Edit)    
	float                                              FinishTime;                                    // 0x028C (0x0004) [0x0000000000002000] (CPF_Transient)
	float                                              Speed;                                         // 0x0290 (0x0004) [0x0000000000002000] (CPF_Transient)
	struct FRenderProfile                              Profile;                                       // 0x0294 (0x0028) [0x0000000000002000] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x02BC (0x0004) MISSED OFFSET
	struct FScriptDelegate                             __EventFinished__Delegate;                     // 0x02C0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0044 (0x052C - 0x0570)
class APawn_X : public APawn
{
public:
	uint8_t                                           UnknownData00[0x4];                            // 0x052C (0x0004) MISSED OFFSET
	float                                              GravityScale;                                  // 0x0530 (0x0004) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                           UnknownData01[0x4];                            // 0x0534 (0x0004) MISSED OFFSET
	class AController*                                 PreviousController;                            // 0x0538 (0x0008) [0x0000000000002000] (CPF_Transient)
	struct FScriptDelegate                             __EventDestroyed__Delegate;                    // 0x0540 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAnimEnd__Delegate;                      // 0x0558 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0040 (0x0280 - 0x02C0)
class ARenderProfiler_X : public AActor
{
public:
	float                                              TimePerPrimitive;                              // 0x0280 (0x0004) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                           UnknownData00[0x4];                            // 0x0284 (0x0004) MISSED OFFSET
	TArray<struct FPrimitiveComponentProfile>          PrimitiveProfiles;                             // 0x0288 (0x0010) [0x0000000000482000] (CPF_Transient | CPF_Component | CPF_NeedCtorLink)
	int32_t                                            CurrentIndex;                                  // 0x0298 (0x0004) [0x0000000000002000] (CPF_Transient)
	uint32_t                                           bInclusive : 1;                                // 0x029C (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
	float                                              PrimitiveTime;                                 // 0x02A0 (0x0004) [0x0000000000002000] (CPF_Transient)
...
public:
	...
	class FString                                      PrivacyPolicyURL;                              // 0x01A0 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      SandboxId;                                     // 0x01B0 (0x0010) [0x0000000000404001] (CPF_Edit | CPF_Config | CPF_NeedCtorLink)
	class FString                                      DeploymentId;                                  // 0x01C0 (0x0010) [0x0000000000404001] (CPF_Edit | CPF_Config | CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           bPendingIncomingTradeInvite : 1;               // 0x0140 (0x0004) [0x0000004000002000] [0x00000004] (CPF_Transient)
	uint32_t                                           bTradeLocked : 1;                              // 0x0140 (0x0004) [0x0008004000000000] [0x00000008] 
	...
	struct FUniqueNetId                                PendingTradeInvite;                            // 0x01A8 (0x0048) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	EPartyProcessingStatus                             ProcessingStatus;                              // 0x01F0 (0x0001) [0x0000004000002000] (CPF_Transient)
	uint8_t                                           UnknownData02[0x7];                            // 0x01F1 (0x0007) MISSED OFFSET
	class FString                                      NotInSameOnlineGameError;                      // 0x01F8 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      MissingLicenseAgreementError;                  // 0x0208 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class UPartySequence_InvitedToPlatformParty_X*     SequenceInvitedToPlatformParty;                // 0x0218 (0x0008) [0x0000004000000000]               
	class UPartySequence_PsyNetPartyUpgrade_X*         SequencePsyNetPartyUpgrade;                    // 0x0220 (0x0008) [0x0001004000000000]               
	class UPartySequence_InvitedToPsyNetParty_X*       SequenceInvitedToPsyNetParty;                  // 0x0228 (0x0008) [0x0001004000000000]               
	class UPartyConfig_X*                              PartyConfig;                                   // 0x0230 (0x0008) [0x0000800000000001] (CPF_Edit)    
	class UPsyNetConfig_X*                             Config;                                        // 0x0238 (0x0008) [0x0000800000000001] (CPF_Edit)    
	class UOnlineLobbyInterface*                       PlatformLobbyInterface_Object;                 // 0x0240 (0x0008) [0x0000004000000000] 
	class UOnlineLobbyInterface*                       PlatformLobbyInterface_Interface;              // 0x0248 (0x0008) [0x0000004000000000]               
	class UParties_X*                                  PsyNetLobbyInterface;                          // 0x0250 (0x0008) [0x0001004000000000]               
	int32_t                                            CreatePartyLocalPlayerNum;                     // 0x0258 (0x0004) [0x0000004000000000]               
	uint8_t                                           UnknownData03[0x4];                            // 0x025C (0x0004) MISSED OFFSET
	class UCrossplayConfig_X*                          CrossplayConfig;                               // 0x0260 (0x0008) [0x0000800000000000]               
	class UFindServerTask_X*                           FindServerTask;                                // 0x0268 (0x0008) [0x0000000000000000]               
	class FString                                      JoinLobbyError;                                // 0x0270 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	TArray<int32_t>                                    LeaderPreferredPlaylists;                      // 0x0280 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyCreated__Delegate;                 // 0x0290 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __OnPartyInviteAccepted__Delegate;             // 0x02A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerInvited__Delegate;                // 0x02C0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerInvitedSilent__Delegate;          // 0x02D8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyChanged__Delegate;                 // 0x02F0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartySizeChanged__Delegate;             // 0x0308 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyLeaderChanged__Delegate;           // 0x0320 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventSearchStatusChanged__Delegate;          // 0x0338 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyError__Delegate;                   // 0x0350 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyJoinGameError__Delegate;           // 0x0368 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyJoinGameSuccess__Delegate;         // 0x0380 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyDestroyed__Delegate;               // 0x0398 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventConfirmJoinGameMessage__Delegate;       // 0x03B0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLeaderLeftOnlineGame__Delegate;         // 0x03C8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventProcessingStatusChanged__Delegate;      // 0x03E0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventDisableCrossPlayChanged__Delegate;      // 0x03F8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerTradingEnabledChanged__Delegate;// 0x0410 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventTradingStatusChanged__Delegate;         // 0x0428 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventInviteToTrade__Delegate;                // 0x0440 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAcceptedInviteToTrade__Delegate;        // 0x0458 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventCloseInviteToTrade__Delegate;           // 0x0470 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerReadyToLock__Delegate;      // 0x0488 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerNotReadyToLock__Delegate;   // 0x04A0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerReadyToConfirm__Delegate;   // 0x04B8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventTradeConfirmed__Delegate;               // 0x04D0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAnotherInviteToTrade__Delegate;         // 0x04E8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerInMatchChanged__Delegate;         // 0x0500 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerIsCurrentlyTrading__Delegate;     // 0x0518 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventStartedJoinFriend__Delegate;            // 0x0530 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAddPartyMember__Delegate;               // 0x0548 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemovePartyMember__Delegate;            // 0x0560 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __bTradeLocked__ChangeNotify;                  // 0x0578 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x03D0 (0x02F0 - 0x06C0)
class AGRI_X : public AGameReplicationInfo
{
public:
	int32_t                                            ReplicatedGamePlaylist;                        // 0x02F0 (0x0004) [0x0000004100002020] (CPF_Net | CPF_Transient)
	int32_t                                            ReplicatedGameMutatorIndex;                    // 0x02F4 (0x0004) [0x0000004100002020] (CPF_Net | CPF_Transient)
	class FString                                      ReplicatedServerRegion;                        // 0x02F8 (0x0010) [0x0000004000402020] (CPF_Net | CPF_Transient | CPF_NeedCtorLink)
	struct FReplicatedReservationData                  Reservations[0x8];                             // 0x0308 (0x0300) [0x0000004100402020] (CPF_Net | CPF_Transient | CPF_NeedCtorLink)
	class FString                                      GameServerID;                                  // 0x0608 (0x0010) [0x0000004000402020] (CPF_Net | CPF_Transient | CPF_NeedCtorLink)
	uint32_t                                           bGameStarted : 1;                              // 0x0618 (0x0004) [0x0000004100002020] [0x00000001] (CPF_Net | CPF_Transient)
	uint32_t                                           bGameEnded : 1;                                // 0x0618 (0x0004) [0x0000000000002000] [0x00000002] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x061C (0x0004) MISSED OFFSET
	class FString                                      MatchGuid;                                     // 0x0620 (0x0010) [0x0000004100400020] (CPF_Net | CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventSpawned__Delegate;                      // 0x0630 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventGameDataSelected__Delegate;             // 0x0648 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventReservationsUpdated__Delegate;          // 0x0660 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventServerNameChanged__Delegate;            // 0x0678 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventGameStarted__Delegate;                  // 0x0690 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventMatchGUIDChanged__Delegate;             // 0x06A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0048 (0x0428 - 0x0470)
class APRI_X : public APlayerReplicationInfo
{
public:
	struct FScriptDelegate                             __EventPlayerNameChanged__Delegate;            // 0x0428 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventUniqueIdChanged__Delegate;              // 0x0440 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventDestroyed__Delegate;                    // 0x0458 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	class UObject*                                     ShowDebugObject;                               // 0x0320 (0x0008) [0x0000000000002000] (CPF_Transient)
	class UDebugDrawer_X*                              DebugDrawer;                                   // 0x0328 (0x0008) [0x0000000000002000] (CPF_Transient)
	class UTexture*                                    DebugTexture;                                  // 0x0330 (0x0008) [0x0000000000002000] (CPF_Transient)
...
{
public:
	class UExplosionComponent_X*                       ExplosionComponent;                            // 0x0280 (0x0008) [0x0000000004080009] (CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline)
	class AFXActor_X*                                  FXActorArchetype;                              // 0x0288 (0x0008) [0x0000000100000021] (CPF_Edit | CPF_Net)
	class AFXActor_X*                                  FXActor;                                       // 0x0290 (0x0008) [0x0000000000002000] (CPF_Transient)
	class APRI_X*                                      Scorer;                                        // 0x0298 (0x0008) [0x0000000000002000] (CPF_Transient)
