...
{
public:
	uint32_t                                           bAutoPlay : 1;                                 // 0x0288 (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           StopWhenOwnerIsDestroyed : 1;                  // 0x0288 (0x0004) [0x0000000000000001] [0x00000002] (CPF_Edit)
	uint32_t                                           bIsPlaying : 1;                                // 0x0288 (0x0004) [0x0000000000002000] [0x00000004] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x028C (0x0004) MISSED OFFSET
	class UAkEvent*                                    PlayEvent;                                     // 0x0290 (0x0008) [0x0000000000000001] (CPF_Edit)    
...
// 0x0011 (0x0280 - 0x0291)
class AAkBusActor : public AActor
{
public:
	class UAkSoundSource*                              SoundSource;                                   // 0x0280 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	struct FName                                       TargetBusName;                                 // 0x0288 (0x0008) [0x0000000000000000]               
	EPinnedAxisType                                    PinnedAxis;                                    // 0x0290 (0x0001) [0x0000000000000000]               
...
// 0x0024 (0x02BC - 0x02E0)
class AAkEnvironmentVolume : public AVolume
{
public:
	uint8_t                                           UnknownData00[0x4];                            // 0x02BC (0x0004) MISSED OFFSET
	struct FAkEnvironment                              Environment;                                   // 0x02C0 (0x0020) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
{
public:
	class UAkPlaySoundComponent*                       PlaySoundComponent;                            // 0x0288 (0x0008) [0x0000000004080009] (CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline)
